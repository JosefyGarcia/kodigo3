...
class SendEmail extends App
{
    ...
    public function sendEmailKodigo()
    {
        try {
             ...
             */
            $mail->addAddress("info@kodigo.org", "KODIGO");
                        ...
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td style="padding: 30px 40px 30px 40px; text-align: center;">
                                    <img width="150px" src="" alt="alt_text" border="0" style="height: auto; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                                </td>
                            </tr>
                            <tr>
