...
EOT;
    ...
    public function testPopBeforeSmtpGood()
    {
        ...
        $this->assertTrue(
            POP3::popBeforeSmtp('', 1100, 10, 'user', 'test', $this->Mail->SMTPDebug),
    ...
    public function testPopBeforeSmtpBad()
    {
        ...
        $this->assertFalse(
            POP3::popBeforeSmtp('', 1101, 10, 'user', 'xxx', $this->Mail->SMTPDebug),
    ...
    public function testSmtpConnect()
    {
        ...
        $this->Mail->smtpClose();
        $this->Mail->Host = "ssl://:12345;tls://:587;10.10.10.10:54321;:12345;10.10.10.10";
        $this->assertFalse($this->Mail->smtpConnect(), 'SMTP bad multi-connect succeeded');
        $this->Mail->smtpClose();
        $this->Mail->Host = ":12345;10.10.10.10:54321;" . $_REQUEST['mail_host'];
        $this->assertTrue($this->Mail->smtpConnect(), 'SMTP multi-connect failed');
        $this->Mail->smtpClose();
        $this->Mail->Host = " :12345 ; " . $_REQUEST['mail_host'] . ' ';
