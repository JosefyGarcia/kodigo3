...
class web_controller extends base_controller{
    ...
    public function contacto(){
        ...
        require_once $this->_helpers->linkTo('contacto.php', 'Views', 'require');
    }
    ...
    public function programas(){
        ...
        require_once $this->_helpers->linkTo('programas.php', 'Views', 'require');
    }

    public function involucrate(){
        
        require_once $this->_helpers->linkTo('involucrate.php', 'Views', 'require');
    }

    public function bootcamp(){
        
        require_once $this->_helpers->linkTo('bootcamp.php', 'Views', 'require');
    }
    public function aprendizaje(){
        
        require_once $this->_helpers->linkTo('aprendizaje.php', 'Views', 'require');
    }
}